#include "1_1.h"
#include <stdio.h>
// unlike the teachers in class, i havent written each fn as a speperate file
// all prgorams are encapsulated in a single file
...
int main() {
  ...
  while (true) {
    ...
    if (choice == 1) {
      ...
      bool visited[graphvertices] = {false};
      visited[j] = true;
      // above and the line below this are usually done within fn
